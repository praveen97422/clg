...
const CACHE_TIMESTAMP_KEY = "cachedCategoriesTimestamp";
...
const Categories = () => {
  ...
  // Read category and subcategory from query params
  ...
  // Filter products by category and subcategory if filters are set
  const filteredProducts = products.filter((product) => {
    const matchesCategory = !categoryFilter || product.category === categoryFilter;
    const matchesSubcategory = !subcategoryFilter || 
      (product.subcategories && product.subcategories.includes(subcategoryFilter));
  ...
  return (
    <div className="home-containers">
      {/* <h2 style={{ paddingTop: "20px", paddingLeft: "20px" }}>
        {categoryFilter ? `Products in "${categoryFilter}"` : "Categories"}
      </h2> */}
